...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		dayNames: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Domingo"], // For formatting
		dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], // For formatting
		dayNamesMin: ["Do","Lu","Ma","Mie","Ju","Vie","Sab"], // Column headings for days starting at Sunday
