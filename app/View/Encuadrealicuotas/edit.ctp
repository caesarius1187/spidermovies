...
<?php echo $this->Form->create('Encuadrealicuota'); ?>
	<fieldset>
		<legend><?php echo __('Edit Encuadrealicuota'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Encuadrealicuota.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Encuadrealicuota.id'))); ?></li>
