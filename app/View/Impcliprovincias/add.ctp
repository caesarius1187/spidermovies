			...
			<div class="div_view">
				<?php
					...
					foreach ($actividadclientes as $key => $actividadcliente) {
						//aca tengo que preguntar si ya existe la actividad guardada en un encuadrealicuota si no existe deberia mostrar un fomulario para agregarla y si existe deberia mostrar un formulario para modificarla
