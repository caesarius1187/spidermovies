...
<?php echo $this->Form->create('Tareascliente'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tareascliente'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tareascliente.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Tareascliente.id'))); ?></li>
