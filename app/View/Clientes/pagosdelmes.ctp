...
function calculateRow($numRow,$iniRow,$finRow,$gcliActual,&$puedePagar,&$totLPago){
    ...
    $colorRojo="background-color:#F00;";
    $colorAzul="background-color:#009FFF;";
    $colorVerde="background-color:#00CC00;";
    $totalRow=0;
    foreach ($lugaresdepago as $lugarpago){           ?>                
        <td id="<?php echo $numRow ?>" class="sithead" valign="top">
            ...
            foreach ($gcliActual['Cliente'] as $cliente) {
                                 ...
                                 <tr>
                                    <?php 
                                            ...
                                            if($eventosimpuesto["tarea13"]=='realizado'){
                                                ...
                                                if($puedePagar>=-1){
                                                    $color=$colorAzul;     
                                                    $title="Se puede pagar: ";                                   
                                                } 
                                                else{ 
                                                    $color=$colorRojo; 
                                                    $title="NO puede pagar: ";  
                                                }
                                            }
                                            ...
                                            $title.=$cliente["nombre"]." - ".$impcli["Impuesto"]["nombre"]." - A Pag: ".$eventosimpuesto["montovto"]." - Pag: ".$eventosimpuesto["montorealizado"]." ".$lugarpago ;
                                                    ...
                                                    ?> 
                                            <td style="<?php echo $color; ?>" title="<?php echo $title?>" onClick="showAvance()">
             ...
             if($showempty){
                    echo '<tr><td title="No hay impuestos registrados">$0,00</td> </tr>';
                }
            ?></table>
        </td>
    <?php  }?>      
...
<table id="pagosdelmes" cellspacing="0" style="width:60%">
    ...
    foreach ($grupoclientesActual as $gcliActual ) {?>
        <tr >
            <th class="sithead" colspan="6" align="left">GRUPO:<?php echo $gcliActual["Grupocliente"]["nombre"]?> </th>                        
        </tr>          
        <tr>
...
<?php /*
    ...
    echo $this->Form->input('periodoanio', array(
                                          'options' => array(
                                              '2014'=>'2014', 
                                              '2015'=>'2015',     
                                              '2016'=>'2016',     
    ...
    echo $this->Form->input('selectby',array('default'=>'none','type'=>'hidden'));
