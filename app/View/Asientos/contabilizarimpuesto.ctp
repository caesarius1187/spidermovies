...
<div class="index">
    ...
    echo $this->Form->input('Asiento.0.cliente_id',['default'=>$impcli['Impcli']['cliente_id'],'type'=>'hidden']);
    echo $this->Form->input('Asiento.0.impcli_id',['default'=>$impcli['Impcli']['id'],'type'=>'hidden']);
    echo $this->Form->input('Asiento.0.periodo',['value'=>$periodo]);
    echo $this->Form->input('Asiento.0.tipoasiento',['default'=>'impuestos','type'=>'hidden']);
