<div class="impclis index">
	<h2><?php echo __('Impclis'); ?></h2>
	...
	<?php foreach ($impclis as $impcli): ?>
	<tr>
		<td><?php echo h($impcli['Impcli']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($impcli['Impcli']['descripcion']); ?>&nbsp;</td>
		<td><?php echo h($impcli['Impcli']['estado']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $impcli['Impcli']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $impcli['Impcli']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $impcli['Impcli']['id']), null, __('Are you sure you want to delete # %s?', $impcli['Impcli']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
