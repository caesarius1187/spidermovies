<div class="terminos">
    ...
    <p style="font-size: 20px;text-align: left">
        ...
        responsabilidades y obligaciones del Usuario y de CONTA al utilizar el 
        servicio, la Plataforma (conforme es definida en estas Condiciones 
        Generales) y cualquier producto o servicio relacionado que ofrezca 
        CONTA (cualquiera de ellos, indistintamente, el “Servicio” y, 
        conjuntamente, los “Servicios”, según corresponda).<br/> 
        ...
        registro como Usuario de CONTA  y/o la utilización del Servicio. En 
        cualquier caso, la utilización del Servicio implica la aceptación por 
    ...
    <?php
    echo $this->Form->create('User',['action'=>'terminosycondiciones',$userid]);
    echo $this->Form->input('id',['value'=>$userid]);
