        ...
        <div id="divRecibo<?php echo $empid;?>" >
            <div id="reciboOriginal<?php echo $empid;?>" class="tblReciboSueldo divToLeft" style="margin: 0px 10px;width: 480px; float:left; ">
                    ...
                    if(!isset($miempleado['horasDias'])) {
                        ...
                        $miempleado['indemnizacionantiguedad'] = 0;
                        $miempleado['preaviso'] = 0;
                    ...
                    foreach ($empleado['Valorrecibo'] as $valorrecibo) {
                        ...
                        // Indemnizacion Antiguedad;
                        if ($valorrecibo['Cctxconcepto']['Concepto']['id']=='104'/*Indemnizacion Antiguedad*/){
                            $indemnizacionantiguedad += $valorrecibo['valor'];
                        }
                        //Preaviso
                        if ($valorrecibo['Cctxconcepto']['Concepto']['id']=='166'/*Preaviso*/){
                            $preaviso += $valorrecibo['valor'];
                        }
                        ...
                        //SAC Cantidad
                        if ($valorrecibo['Cctxconcepto']['Concepto']['id']=='57'/*SAC dias*/){
                            $sacdias += $valorrecibo['valor'];
                        }
                        //Inasistencia pagas
                        ...
                        if (in_array($valorrecibo['Cctxconcepto']['Concepto']['id'],
                            ...
                            $sacnoremunerativo += $valorrecibo['valor'];
                        }
                    ...
                    $miempleado['indemnizacionantiguedad']=$indemnizacionantiguedad;
                    $miempleado['preaviso']=$preaviso;
...
//                                        strftime('%B del %Y',strtotime('01-'.$pemes.'-'.$peanio));
                        ...
                        if($miempleado['sac']*1>0){ ?>
                            <tr class="trConceptoRecibo">
                                ...
                                <td class="tdWithLeftRightBorder tdWithNumber">
                                    <?php echo number_format($miempleado['sacdias'], 2, ",", "."); ?>
                                </td>
                                <td class="tdWithLeftRightBorder tdWithNumber">
...
<!--                        --><?php //}
                        ...
                        <?php }
                        if($miempleado['indemnizacionantiguedad']*1>0){ ?>
                            <tr class="trConceptoRecibo">
                                <td class="tdWithLeftRightBorder">
                                    501
                                </td>
                                ...
                                <td class="tdWithLeftRightBorder tdWithNumber">
                                    <?php echo number_format($miempleado['indemnizacionantiguedad'], 2, ",", "."); ?>
                                </td>
                                <td class="tdWithLeftRightBorder tdWithNumber">
                                </td>
                            </tr>
                        ...
                        if($miempleado['preaviso']*1>0){ ?>
                            <tr class="trConceptoRecibo">
                                ...
                                <td class="tdWithLeftRightBorder tdWithNumber">
                                    <?php echo number_format($miempleado['preaviso'], 2, ",", "."); ?>
                                </td>
                                <td class="tdWithLeftRightBorder tdWithNumber">
                                </td>
                            </tr>
