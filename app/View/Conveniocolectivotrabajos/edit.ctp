...
<?php echo $this->Form->create('Conveniocolectivotrabajo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Conveniocolectivotrabajo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Conveniocolectivotrabajo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Conveniocolectivotrabajo.id'))); ?></li>
