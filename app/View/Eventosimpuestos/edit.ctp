<div class="eventosimpuestos form">
<?php echo $this->Form->create('Eventosimpuesto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Eventosimpuesto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Eventosimpuesto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Eventosimpuesto.id'))); ?></li>
