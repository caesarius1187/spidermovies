...
<?php echo $this->Form->create('Cctxconcepto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cctxconcepto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cctxconcepto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Cctxconcepto.id'))); ?></li>
